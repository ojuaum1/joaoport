      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
            src="./assets/images/projects/VitalHub.png"
              alt="imagem do projeto VitalHub."
            />
            <div class="buttons">
              <a href="https://github.com/ojuaum1/G11-VitalHub" target="_blank" title="Repositório no Github">
                <svg
          ...
          <p>
            Aplicativo de uma clinica medica para facilitar o dia a dia do usuario.
          </p>
          <p>REACT NATIVE - CSS - JS - SQL SERVER - C#</p>
        </div>
